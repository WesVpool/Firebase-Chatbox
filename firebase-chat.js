(function () {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyBdixsjG_E1qzqLtCaeoYOxm9Er-RNlx1Q",
    authDomain: "corso-8699c.firebaseapp.com",
    databaseURL: "https://corso-8699c-default-rtdb.firebaseio.com",
    projectId: "corso-8699c",
    storageBucket: "corso-8699c.appspot.com",
    messagingSenderId: "995915972748",
    appId: "1:995915972748:web:7c8710d38caf1d8c6ffba9",
    measurementId: "G-3GKBNJLZBG"
  };
  // Initialize Firebase
  ...
  function updateCurrentUser(userEmail) {
    userNameDisplay.innerText = `Logged in as ${userEmail}`;
  ...
  logout.addEventListener('click', (e) => {
    firebase
      ...
      .then((resp) => {
        ...
        updateCurrentUser('');
        userNameDisplay.innerText = "Please Login!";
      })
